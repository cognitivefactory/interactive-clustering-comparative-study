...
* Description:  Worker to make overviews of interactive clustering convergence study experiments.
* Author:       Erwan Schild
* Created:      24/05/2021
...
def experiments_performance_overview(
    ...
    # Store the graph.
    fig.savefig(
        "../results/plot_global_performances_evolution.png",
        dpi=300,
        transparent=True,
        bbox_inches="tight",
    )
...
def experiments_time_overview(
    ...
    # Store the graph.
    fig.savefig(
        "../results/plot_global_computation_times_evolution.png",
        dpi=300,
        transparent=True,
        bbox_inches="tight",
    )
