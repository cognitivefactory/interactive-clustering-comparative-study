...
* Description:  Worker to synthesize results of interactive clustering comparative study experiments in an CSV file.
* Author:       Erwan Schild
* Created:      24/05/2021
...
def experiments_synthesis(
    ...
    for env_path in list_of_experiment_environments:
        ...
        # NB : envrinomnts path are formatted link : `../experiments/[DATASET]/[PREPROCESSING]/[VECTORIZATION]/[SAMPLING]/[CLUSTERING]/[EXPERIMENT]/`
    ...
    # Define file path.
    filepath: str = "../experiments/" + "experiments_synthesis.csv"
